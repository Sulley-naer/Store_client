  ...
  <div style="height: 400px">
    <div class="mid" style='margin-bottom: 1em;margin-inline: auto;width: max-content;'>
      ...
      >
        ...
        <template #prepend>
        <el-select v-model="select" placeholder="任意" size='large' style="width: 115px;height: 100%" @change="GetData()">
...
import { type Column, ElInput, ElNotification, ElSelectV2,ElButton } from 'element-plus'
...
const columns = [
  ...
  },
  {
    ...
    cellRenderer: ({ rowData, column }) => {
      ...
      return(
        <ElButton size="default" onClick={onChange} icon={Delete}/>
      )
    },
    width: 150,
    align: 'center',
